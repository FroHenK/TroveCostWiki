...
public enum TroveItem implements Serializable {
    ...
    TWICE_FORGED_SHADOW_SOUL("Twice-Forged Shadow Soul","1:850 - 1:950",NavigationItem.FORGING_MATERIALS),
    ...
    RADIANT("Radiant","1:200k - 1:270k",NavigationItem.EQUIPMENT),
    SHADOW_LEVEL_2_RING("Shadow Level 2 Ring","1:200 - 1:300",NavigationItem.RINGS),
    PD_S2("PD/ER|MD/J) S2","1:400 - 1:500",NavigationItem.RINGS),
    SHADOW_LEVEL_3_RING("Shadow Level 3 Ring","1:1,000 - 1:2,000",NavigationItem.RINGS),
    PD_S3("PD/ER|MD/J) S3","1:2,500 - 1:3,000",NavigationItem.RINGS),
    ...
    PINK_COOKIEPHANT("Pink Cookiephant","1:10k - 1:20k",NavigationItem.MOUNTS),
    BLUE_COOKIEPHANT("Blue Cookiephant","1:10k - 1:20k",NavigationItem.MOUNTS),
    EGGSTER_BOUNCER("Eggster Bouncer","1:10k - 1:20k",NavigationItem.MOUNTS),
    CHOCOLATE_CHICANERY("Chocolate Chicanery","1:10k - 1:20k",NavigationItem.MOUNTS),
    TRUEFIRE_PHOENIX("Truefire Phoenix","1:10k - 1:20k",NavigationItem.MOUNTS),
    BALEFIRE_PHOENIX("Balefire Phoenix","1:10k - 1:20k",NavigationItem.MOUNTS),
    BLUE_BUDGIE_BUDDY("Blue Budgie Buddy","1:10k - 1:20k",NavigationItem.MOUNTS),
    PINK_BUDGIE_BUDDY("Pink Budgie Buddy","1:10k - 1:20k",NavigationItem.MOUNTS),
    SHUFFLING_SHRIMP_NIGIRI("Shuffling Shrimp Nigiri","1:10k - 1:20k",NavigationItem.MOUNTS),
    DELICIOUS_DRAGON_ROLL("Delicious Dragon Roll","1:10k - 1:20k",NavigationItem.MOUNTS),
    KAMI_OF_SCORCHED_SKIES("Kami of Scorched Skies","1:10k - 1:20k",NavigationItem.MOUNTS),
    KAMI_OF_SHELTERED_SHORES("Kami of Sheltered Shores","1:10k - 1:20k",NavigationItem.MOUNTS),
    PRODIGAL_PERIDOTER("Prodigal Peridoter","1:10k - 1:20k",NavigationItem.MOUNTS),
    PAUNCHY_DRAGON_PUP("Paunchy Dragon Pup","1:10k - 1:20k",NavigationItem.MOUNTS),
    GIANT_RED_PANDA("Giant Red Panda","1:1,000 - 1:2,000",NavigationItem.MOUNTS),
    GIANT_FAE_PANDA("Giant Fae Panda","1:1,000 - 1:2,000",NavigationItem.MOUNTS),
    BLUE_MANTA_RAY("Blue Manta Ray","1:1,000 - 1:2,000",NavigationItem.MOUNTS),
    GREEN_MANTA_RAY("Green Manta Ray","1:1,000 - 1:2,000",NavigationItem.MOUNTS),
    ...
    SPIKEWALKER_HATCHLING("Spikewalker Hatchling","1:100k",NavigationItem.MOUNTS),
    ...
    RUDOLPH_RAPTOR("Rudolph Raptor","1:60k - 1:80k",NavigationItem.MOUNTS),
    SNUG_SNOWMAN("Snug Snowman","1:50k - 1:60k",NavigationItem.MOUNTS),
    REVELING_REINDEER("Reveling Reindeer","1:60k - 1:80k",NavigationItem.MOUNTS),
    ...
    MAHOGAN_TOBOGGAN("Mahogan Toboggan","1:30k - 1:35k",NavigationItem.MAG_RIDERS),
    LADEN_SLEIGH("Laden Sleigh","1:50k - 1:70k",NavigationItem.MAG_RIDERS),
    NEON_NIGHTSKY("Neon Nightsky","1:32k - 1:36k",NavigationItem.WINGS),
    STORMCALLERS_WINGS("Stormcaller's Wings","1:65k - 1:75k",NavigationItem.WINGS),
    XERO_LINE_WINGS("Xero Line Wings","1:65k - 1:75k",NavigationItem.WINGS),
    BLOODSEEKER_WINGS("Bloodseeker Wings","1:65k - 1:75k",NavigationItem.WINGS),
    ...
    CHRONOMANCER_QUBESLY("Chronomancer Qubesly","1:5k - 1:5.5k",NavigationItem.ALLIES),
    PROWLING_SHADOW("Prowling Shadow","1:5k - 1:5.5k",NavigationItem.ALLIES),
    ...
    NIGHT_OWL("Night Owl","1:60k",NavigationItem.FAE_TRICKSTER),
    ...
    MECHA_DRACOLYTE("Mecha-Dracolyte","1:100k",NavigationItem.DRACOLYTE),
    ...
    SAKURA_SAGE("Sakura Sage","1:60k",NavigationItem.ICE_SAGE),
    ...
    SHIPYARD_SCAVENGER("Shipyard Scavenger","1:60k",NavigationItem.PIRATE_CAPTAIN),
    ...
    COMIC_HERO("Comic Hero","1:60k",NavigationItem.BOOMERANGER),
    MAGIC_MAN("Magic Man","1:60k",NavigationItem.BOOMERANGER),
    SOULKEEPER("Soulkeeper","1:35k - 1:40k",NavigationItem.TOMB_RAISER),
    ACIDIC("Acidic","1:35k - 1:40k",NavigationItem.TOMB_RAISER),
    FUNEREAL_PHARAOH("Funereal Pharaoh","1:60k",NavigationItem.TOMB_RAISER),
    ...
    MONKEY_KING("Monkey King","1:60k",NavigationItem.LUNAR_LANCER);
