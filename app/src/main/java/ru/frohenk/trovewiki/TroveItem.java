...
public enum TroveItem implements Serializable {
    ...
    AZULIAN_DRAGON_SOUL("Azulian Dragon Soul","1:7,000 - 1:9,000",NavigationItem.DRAGONS),
    ...
    MOONWING_DRAGON_SOUL("Moonwing Dragon Soul","1:800 - 1:1,000",NavigationItem.DRAGONS),
    DRAGON_COIN("Dragon Coin","1:1,000 - 1:1,200",NavigationItem.DRAGONS),
    ...
    SHAPESTONE_ORE("Shapestone Ore","1:1 - 1:2",NavigationItem.COMMON_ORES),
    FORMICITE_ORE("Formicite Ore","1:1",NavigationItem.COMMON_ORES),
    INFINIUM_ORE("Infinium Ore","1:3 - 1:5",NavigationItem.COMMON_ORES),
    FLUX("Flux","1:3 Glim",NavigationItem.FORGING_MATERIALS),
    EYE_OF_QBTHULHU("Eye of Q'bthulhu","1:4.7 - 1:5",NavigationItem.FORGING_MATERIALS),
    ...
    TWICE_FORGED_SHADOW_SOUL("Twice-Forged Shadow Soul","1:800 - 1:900",NavigationItem.FORGING_MATERIALS),
    THRICE_FORGED_SHADOW_SOUL("Thrice-Forged Shadow Soul","1:4,000 - 1:5,000",NavigationItem.FORGING_MATERIALS),
    QUAD_FORGED_SHADOW_SOUL("Quad-Forged Shadow Soul","1:13k - 1:14k",NavigationItem.FORGING_MATERIALS),
    PENTA_FORGED_SHADOW_SOUL("Penta-Forged Shadow Soul","1:39k - 1:42k",NavigationItem.FORGING_MATERIALS),
    ...
    BLANK_SCROLL("Blank Scroll","1:150 - 1:250",NavigationItem.RUNECRAFTING),
    ...
    MINERS_TROVE("Miner's Trove","1:20 - 1:50",NavigationItem.LOOTBOXES),
    ...
    CLASS_COIN("Class Coin","1:45k - 1:60k",NavigationItem.COINS),
    ...
    CHAOS_COIN("Chaos Coin","1:600k++",NavigationItem.COINS),
    SHADOW_KEY("Shadow Key","1:50 - 1:70",NavigationItem.KEYS),
    ...
    COMMON_FISH("Common Fish","1:10",NavigationItem.FISHES_AND_RESOURCES),
    UNCOMMON_FISH("Uncommon Fish","1:100 - 1:200",NavigationItem.FISHES_AND_RESOURCES),
    ...
    RADIANT("Radiant","1:160k - 1:200k+",NavigationItem.EQUIPMENT),
    ...
    SHADOW_LEVEL_4_RING_W_ENERGY_REGEN("Shadow Level 4 Ring w/ Energy Regen","1:80k - 1:160k",NavigationItem.RINGS),
    SHADOW_LEVEL_4_RING_W_CRITICAL_HIT("Shadow Level 4 Ring w/ Critical Hit","1:80k - 1:160k",NavigationItem.RINGS),
    PINK_COOKIEPHANT("Pink Cookiephant","1:30k",NavigationItem.MOUNTS),
    BLUE_COOKIEPHANT("Blue Cookiephant","1:30k",NavigationItem.MOUNTS),
    ...
    FLOATING_FORMULA("Floating Formula","1:23k - 1:36k",NavigationItem.MOUNTS),
    ...
    SS_DRACONIC("SS Draconic","1:85k - 1:95k",NavigationItem.BOATS),
    SS_DUTCHMAN("SS Dutchman","1:85k - 1:95k",NavigationItem.BOATS),
    ...
    WINGS_OF_DARKEST_NIGHT("Wings of Darkest Night","1:12k - 1:15k",NavigationItem.WINGS),
    ...
    DIGGSLY("Diggsly","1:750 - 1:850",NavigationItem.ALLIES),
    COTTON_CANDY("Cotton Candy","1:140k - 1:190k",NavigationItem.ALLIES),
    _TREASURE_COMMONS("Treasure Commons","1:100 - 1:170",NavigationItem.ALLIES),
    ...
    DRAGON_COIN_DIGEST("Dragon Coin Digest","1:100k - 1:150k",NavigationItem.TOMES),
    CHAOS_CODEX("Chaos Codex","1:100k - 1:200k",NavigationItem.TOMES),
    ...
    SANTA_BARBARIAN("Santa Barbarian","1:100k - 1:120k",NavigationItem.CANDY_BARBARIAN),
